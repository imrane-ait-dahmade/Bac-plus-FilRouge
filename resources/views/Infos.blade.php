        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                <div class="md:col-span-2 p-6 space-y-6 border-r border-gray-200">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div>
                            ...
                            @endif
                            <span
                                class="mt-1 inline-block px-2 py-0.5 text-xs font-medium rounded-full {{ $etablissement->typeecole == 'Public' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800' }}">
                        ...
                        <div class="space-y-2 text-sm text-gray-600">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-gray-400 flex-shrink-0"
                                     fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                          d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/> {{-- Changed icon to map/region --}}
                                </svg>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            ...
                            <div class="bg-gray-50 p-3 rounded-lg border border-gray-200 sm:col-span-2">
                                ...
                                <div
                                    class="text-gray-800">{{ $etablissement->nombreetudiant ? number_format($etablissement->nombreetudiant, 0, ',', ' ') : 'N/A' }}</div>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($etablissement->filieres as $filiere)
                                    <div
                                        ...
                                        @if($filiere->description)
                                            {{-- Assuming 'description_filiere' field exists --}}
                    ...
                    {{-- Metadata --}}
                    <div
                        class="pt-4 border-t border-gray-200 text-xs text-gray-400 mt-auto"> {{-- Added mt-auto in case column is short --}}
                        <p>Créé le: {{ optional($etablissement->created_at)->format('d/m/Y H:i') ?? 'N/A' }}</p>
                        <p>Dernière mise à
                            jour: {{ optional($etablissement->updated_at)->format('d/m/Y H:i') ?? 'N/A' }}</p>
                    </div>
                ...
                <div class="p-6 bg-gray-50 space-y-6">
                    ...
                    {{-- Social Media --}}
                    @if($etablissement->facebook || $etablissement->instagram || $etablissement->linkedin || $etablissement->twitter)
