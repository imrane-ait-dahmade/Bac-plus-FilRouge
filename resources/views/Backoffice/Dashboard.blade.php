        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6 border-l-4 border-custom-primary shadow-lg">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="mt-4 md:mt-0 flex space-x-3">
                    ...
                    <a href="{{route('Etablissements.create')}}"  class="bg-custom-primary hover:bg-custom-dark text-white px-4 py-2 rounded-md transition duration-300 flex items-center">
