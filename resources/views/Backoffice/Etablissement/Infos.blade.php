    ...
    <div class="max-w-4xl mx-auto p-6">
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <a href=""
                   class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-md transition duration-150 ease-in-out flex items-center">
                ...
                <a href="{{route('etablissement.FormEdit', ['etablisement' => $etablissement->id])}}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2 space-y-6">
                        <div>
                            ...
                            <div class="flex items-center text-gray-600 mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-custom-primary"
                            ...
                            <div class="flex items-center text-gray-600">
                                ...
                                Type: <span
                                    class="ml-1 px-2 py-1 text-xs rounded-full {{ $etablissement->typeecole == 'Public' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800' }}">
                        ...
                        <div class="border-t border-gray-200 pt-4">
                            ...
                            <div class="mt-4 bg-gray-50 p-4 rounded-lg">
                                ...
                                <div
                                    class="font-medium">{{ number_format($etablissement->nombreetudiant, 0, ',', ' ') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            @else
                                <div class="w-full h-48 bg-custom-light rounded-lg flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-custom-primary"
                                         fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="mt-4">
                            ...
                            <a href="#"
                               class="block py-2 px-4 bg-custom-primary hover:bg-custom-dark text-white rounded-md text-center transition duration-150 ease-in-out">
